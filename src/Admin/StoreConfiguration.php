...
class StoreConfiguration
{
    ...
    public static function register_settings()
    {
        ...
        add_settings_section('commeriq_store_section', __('Store Configuration', 'wontonee-commeriq'), [__CLASS__, 'section_cb'], 'commeriq-settings');

        add_settings_field('store_preview', __('Store Details', 'wontonee-commeriq'), [__CLASS__, 'field_store_preview'], 'commeriq-settings', 'commeriq_store_section');
        add_settings_field('industry', __('Industry', 'wontonee-commeriq'), [__CLASS__, 'field_industry'], 'commeriq-settings', 'commeriq_store_section');
        add_settings_field('business_type', __('Business Type', 'wontonee-commeriq'), [__CLASS__, 'field_business_type'], 'commeriq-settings', 'commeriq_store_section');
    }
    ...
    {
        echo '<p>' . esc_html__('CommerIQ reads base WooCommerce store details and stores them here for AI context.', 'wontonee-commeriq') . '</p>';
    }
    ...
    public static function field_store_preview()
    {
        ...
        echo '<p><strong>' . esc_html__('Country', 'wontonee-commeriq') . ':</strong> ' . esc_html($country) . '</p>';
        echo '<p><strong>' . esc_html__('Currency', 'wontonee-commeriq') . ':</strong> ' . esc_html($currency) . '</p>';
        echo '<p><strong>' . esc_html__('State/Region', 'wontonee-commeriq') . ':</strong> ' . esc_html($state) . '</p>';
        echo '</div>';
    }
