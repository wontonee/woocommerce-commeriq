...
class SettingsPage
{
    ...
    public static function register_settings()
    {
        ...
        add_settings_section('commeriq_license_section', __('Licence', 'woocommerce-commeriq'), [__CLASS__, 'section_cb'], 'commeriq-settings');

        add_settings_field('licence_key', __('Licence Key', 'woocommerce-commeriq'), [__CLASS__, 'field_licence_key'], 'commeriq-settings', 'commeriq_license_section');
        add_settings_field('domain_name', __('Domain Name', 'woocommerce-commeriq'), [__CLASS__, 'field_domain_name'], 'commeriq-settings', 'commeriq_license_section');
    }
    ...
    {
        echo '<p>' . esc_html__('Enter your licence details.', 'woocommerce-commeriq') . '</p>';
    }
