    ...
    public static function admin_assets($hook)
    {
        ...
        if (strpos($hook, 'commeriq-settings') !== false) {
            ...
            wp_localize_script('commeriq-admin-settings', 'commeriqSettings', [
                'i18n' => [
                    'apiRequired' => __('API Credentials Required', 'wontonee-commeriq'),
                    'apiRequiredMessage' => __('Please configure your API credentials to access this feature.', 'wontonee-commeriq'),
                    'removeApi' => __('Remove API Credentials?', 'wontonee-commeriq'),
                    'removeApiMessage' => __('Are you sure you want to remove your API credentials? You will need to re-enter them to use AI features.', 'wontonee-commeriq'),
                    'processing' => __('Processing', 'wontonee-commeriq'),
                    'removingApi' => __('Removing API credentials...', 'wontonee-commeriq'),
                    'success' => __('Success', 'wontonee-commeriq'),
                    'apiRemovedSuccess' => __('API credentials removed successfully', 'wontonee-commeriq'),
                    'error' => __('Error', 'wontonee-commeriq'),
                    'apiRemoveFailed' => __('Failed to remove API credentials', 'wontonee-commeriq'),
                    ...
                    'savingApi' => __('Saving API credentials...', 'wontonee-commeriq'),
                    'apiSavedSuccess' => __('API credentials saved successfully', 'wontonee-commeriq'),
                    'saveFailed' => __('Save Failed', 'wontonee-commeriq'),
                    'apiSaveFailed' => __('Failed to save API credentials', 'wontonee-commeriq'),
