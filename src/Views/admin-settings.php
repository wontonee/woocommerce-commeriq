...
<div class="wrap commeriq-admin-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a class="<?php echo esc_attr($store_tab_class); ?>" href="#tab-store" data-disabled="<?php echo esc_attr($is_active ? '0' : '1'); ?>"><?php esc_html_e('Store Analyzer', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?></a>
    </h2>
                        ...
                        <form id="commeriq-modify-form" class="commeriq-license-form">
                            ...
                            <div class="commeriq-form-grid">
                                <div class="commeriq-form-field">
                                    ...
                                    <input type="text" id="modify_licence_key" name="licence_key" value="<?php echo esc_attr($licence_key); ?>" placeholder="<?php esc_attr_e('Enter your license key', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?>" required>
                                </div>
                                <div class="commeriq-form-field">
                                    <label for="modify_domain_name"><?php esc_html_e('Domain', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?></label>
                                    <input type="text" id="modify_domain_name" name="domain_name" value="<?php echo esc_attr($domain_name); ?>" placeholder="<?php esc_attr_e('example.com', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?>" required>
                                </div>
                            </div>
                        ...
                        <form id="commeriq-license-form" class="commeriq-license-form">
                            ...
                            <div class="commeriq-form-grid">
                                ...
                                <div class="commeriq-form-field">
                                    ...
                                    <input type="text" id="domain_name" name="domain_name" value="<?php echo esc_attr($current_domain); ?>" placeholder="<?php esc_attr_e('example.com', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?>" required>
                    ...
                    <div class="commeriq-info-card">
                        ...
                        <div class="commeriq-info-body">
                            <div class="commeriq-info-row">
                                ...
                                <span class="commeriq-info-value"><?php echo esc_html($store_data['country'] ?: __('Not Set', 'commeriq-ai-powered-commerce-insights-for-woocommerce')); ?></span>
                            </div>
                            <div class="commeriq-info-row">
                                <span class="commeriq-info-label"><?php esc_html_e('State/Region', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?></span>
                                <span class="commeriq-info-value"><?php echo esc_html($store_data['state'] ?: __('Not Set', 'commeriq-ai-powered-commerce-insights-for-woocommerce')); ?></span>
                            </div>
                            <div class="commeriq-info-row">
                                <span class="commeriq-info-label"><?php esc_html_e('City', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?></span>
                                <span class="commeriq-info-value"><?php echo esc_html($store_data['city'] ?: __('Not Set', 'commeriq-ai-powered-commerce-insights-for-woocommerce')); ?></span>
                            </div>
                            <div class="commeriq-info-row">
                                <span class="commeriq-info-label"><?php esc_html_e('Postal Code', 'commeriq-ai-powered-commerce-insights-for-woocommerce'); ?></span>
                                <span class="commeriq-info-value"><?php echo esc_html($store_data['postcode'] ?: __('Not Set', 'commeriq-ai-powered-commerce-insights-for-woocommerce')); ?></span>
                            </div>
